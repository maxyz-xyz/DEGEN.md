...
| [Chainlink](https://github.com/smartcontractkit/chainlink-agent-skills) | Infra | Oracle, messaging, and data — CRE workflow generation, CCIP cross-chain sends, Data Feeds integration (price feeds, SmartData, SVR/OEV), contract scaffolding, token bridging via CCT | Skill | — | Yes | [llms.txt](https://docs.chain.link/llms.txt) | `npx skills add smartcontractkit/chainlink-agent-skills` |
